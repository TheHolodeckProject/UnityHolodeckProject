...
public enum RecorderState1 {
  Idling1 = 0,
  Recording1 = 1,
  Playing1 = 2
}

public class LeapRecorder1{

  public float speed = 1.0f;
  public bool loop = true;
  public RecorderState1 state = RecorderState1.Playing1;

  protected List<byte[]> frames_;
  protected float frame_index_;
  protected Frame current_frame_ = new Frame();
  
  public LeapRecorder1() {
    Reset();
  }

  public void Stop() {
    state = RecorderState1.Idling1;
    frame_index_ = 0.0f;
  }
  ...
  public void Play() {
    state = RecorderState1.Playing1;
  }

  public void Record() {
    state = RecorderState1.Recording1;
  }
